...
export default function EditRoute() {
  ...
  // Mock pre-loaded data (same regardless of routeId)
  const [routeName, setRouteName] = useState('Morning Commute');
  const [buses, setBuses] = useState<BusInRoute[]>([
    {
      id: '1',
      busNumber: 'M15',
      direction: 'Downtown',
      stop: 'Broadway & 42nd St',
    },
    {
      id: '2',
      busNumber: 'M20',
  ...
  const handleSaveRoute = () => {
    console.log('Updating route:', { routeId, routeName, buses });
    navigate('/main');
  };
